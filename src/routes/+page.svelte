...
<svelte:head>
	...
	<meta property="og:url" content="https://esmodule.com/" />
	<meta property="og:title" content="ES Modules - The JavaScript module system" />
	<meta
		property="og:description"
		content="A guide to ES modules, the module system of JavaScript."
	/>
</svelte:head>
...
<main class="page">
	<div class="container">
		<header class="hero">
			...
			<p class="intro">
				Introduced in the ES6 specification, ECMAScript modules (ES modules or ESM) is the
				standardized format for packaging and organizing JavaScript code. It provides a native,
...
<style>
	...
	.highlight {
		background: linear-gradient(var(--accent-tint), var(--accent-tint)) no-repeat;
